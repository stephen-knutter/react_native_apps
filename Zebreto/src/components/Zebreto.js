...
export class Zebreto extends Component {
  constructor() {
    this.displayName = 'Zebreto';
    this.mixins = [Reflux.connect(DeckMetaStore, 'deckMetas')];
    ...
    this._renderScene = route => {
      switch(route.name) {
        ...
        case 'createCards':
          return <NewCard review={this.review} quit={this.goHome} nextCard={this.createdDeck} {...route.data} />;
        case 'review':
